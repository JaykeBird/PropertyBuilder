...
namespace PropertyBuilderWPF
{
    ...
    public partial class MainWindow : FlatWindow
    {
        ...
        void SetBindings()
        {
            ...
            bpg.SetBinding(BulkPropertyGenerator.EditorFontFamilyProperty, fontFamilyBinding);
            bpg.SetBinding(BulkPropertyGenerator.EditorFontSizeProperty, fontSizeBinding);
            bpg.SetBinding(BulkPropertyGenerator.EditorFontStyleProperty, fontStyleBinding);
            bpg.SetBinding(BulkPropertyGenerator.EditorFontWeightProperty, fontWeightBinding);
            bpg.SetBinding(BulkPropertyGenerator.ShowLineNumbersProperty, lineNumbersBinding);
            bpg.SetBinding(BulkPropertyGenerator.WordWrapProperty, wordWrapBinding);
            bpg.SetBinding(BulkPropertyGenerator.HighlightCurrentLineProperty, highlightBinding);
            bpg.SetBinding(BulkPropertyGenerator.UseSyntaxHighlightingProperty, syntaxColorBinding);
